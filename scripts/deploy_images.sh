...
source_dir="/home/student/Desktop/yocto_pynq/Yocto_project_pynq_board/build/tmp/deploy/images/pynq"

# Define the source files
source_files=("uImage" "u-boot.img" "boot.bin" "core-image-minimal-pynq.cpio.gz.u-boot" "uEnv.txt" "devicetree.dtb")

# Define the destination directory
destination_dir="/home/student/Desktop/yocto_pynq/Yocto_project_pynq_board/build/tmp/deploy/images/pynq/tmp"
