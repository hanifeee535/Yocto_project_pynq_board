/* Generated automatically by the program 'build/genpreds'
   from the machine description file '../../../../../../../work-shared/gcc-7.3.0-r0/gcc-7.3.0/gcc/config/arm/arm.md'.  */
...
satisfies_constraint_j (rtx op)
{
  ...
  if (CONST_INT_P (op))
    ival = INTVAL (op);
  return (
#line 71 "../../../../../../../work-shared/gcc-7.3.0-r0/gcc-7.3.0/gcc/config/arm/constraints.md"
(TARGET_HAVE_MOVT)) && (((GET_CODE (op) == HIGH) && (
#line 73 "../../../../../../../work-shared/gcc-7.3.0-r0/gcc-7.3.0/gcc/config/arm/constraints.md"
(arm_valid_symbolic_address_p (XEXP (op, 0))))) || ((GET_CODE (op) == CONST_INT) && (
#line 75 "../../../../../../../work-shared/gcc-7.3.0-r0/gcc-7.3.0/gcc/config/arm/constraints.md"
((ival & 0xffff0000) == 0))));
}
static inline bool
...
#line 80 "../../../../../../../work-shared/gcc-7.3.0-r0/gcc-7.3.0/gcc/config/arm/constraints.md"
(TARGET_THUMB2)) && (
#line 81 "../../../../../../../work-shared/gcc-7.3.0-r0/gcc-7.3.0/gcc/config/arm/constraints.md"
((ival & 0xfffff000) == 0)));
}
static inline bool
satisfies_constraint_PJ (rtx op)
{
  ...
  if (CONST_INT_P (op))
    ival = INTVAL (op);
  return (GET_CODE (op) == CONST_INT) && ((
#line 86 "../../../../../../../work-shared/gcc-7.3.0-r0/gcc-7.3.0/gcc/config/arm/constraints.md"
(TARGET_THUMB2)) && (
#line 87 "../../../../../../../work-shared/gcc-7.3.0-r0/gcc-7.3.0/gcc/config/arm/constraints.md"
(((-ival) & 0xfffff000) == 0)));
}
static inline bool
satisfies_constraint_I (rtx op)
{
  ...
  if (CONST_INT_P (op))
    ival = INTVAL (op);
  return (GET_CODE (op) == CONST_INT) && (
#line 110 "../../../../../../../work-shared/gcc-7.3.0-r0/gcc-7.3.0/gcc/config/arm/constraints.md"
...
satisfies_constraint_J (rtx op)
{
  ...
  if (CONST_INT_P (op))
    ival = INTVAL (op);
  return (GET_CODE (op) == CONST_INT) && (
#line 117 "../../../../../../../work-shared/gcc-7.3.0-r0/gcc-7.3.0/gcc/config/arm/constraints.md"
...
satisfies_constraint_K (rtx op)
{
  ...
  if (CONST_INT_P (op))
    ival = INTVAL (op);
  return (GET_CODE (op) == CONST_INT) && (
#line 125 "../../../../../../../work-shared/gcc-7.3.0-r0/gcc-7.3.0/gcc/config/arm/constraints.md"
(TARGET_32BIT ? const_ok_for_arm (~ival)
...
satisfies_constraint_L (rtx op)
{
  ...
  if (CONST_INT_P (op))
    ival = INTVAL (op);
  return (GET_CODE (op) == CONST_INT) && (
#line 132 "../../../../../../../work-shared/gcc-7.3.0-r0/gcc-7.3.0/gcc/config/arm/constraints.md"
(TARGET_32BIT ? const_ok_for_arm (-ival)
		   : (ival >= -7 && ival <= 7)));
}
static inline bool
satisfies_constraint_M (rtx op)
{
  ...
  if (CONST_INT_P (op))
    ival = INTVAL (op);
  return (GET_CODE (op) == CONST_INT) && (
#line 141 "../../../../../../../work-shared/gcc-7.3.0-r0/gcc-7.3.0/gcc/config/arm/constraints.md"
...
satisfies_constraint_N (rtx op)
{
  ...
  if (CONST_INT_P (op))
    ival = INTVAL (op);
  return (GET_CODE (op) == CONST_INT) && (
#line 148 "../../../../../../../work-shared/gcc-7.3.0-r0/gcc-7.3.0/gcc/config/arm/constraints.md"
...
satisfies_constraint_O (rtx op)
{
  ...
  if (CONST_INT_P (op))
    ival = INTVAL (op);
  return (GET_CODE (op) == CONST_INT) && (
#line 154 "../../../../../../../work-shared/gcc-7.3.0-r0/gcc-7.3.0/gcc/config/arm/constraints.md"
...
satisfies_constraint_Pa (rtx op)
{
  ...
  if (CONST_INT_P (op))
    ival = INTVAL (op);
  return (GET_CODE (op) == CONST_INT) && (
#line 160 "../../../../../../../work-shared/gcc-7.3.0-r0/gcc-7.3.0/gcc/config/arm/constraints.md"
...
satisfies_constraint_Pb (rtx op)
{
  ...
  if (CONST_INT_P (op))
    ival = INTVAL (op);
  return (GET_CODE (op) == CONST_INT) && (
#line 166 "../../../../../../../work-shared/gcc-7.3.0-r0/gcc-7.3.0/gcc/config/arm/constraints.md"
...
satisfies_constraint_Pc (rtx op)
{
  ...
  if (CONST_INT_P (op))
    ival = INTVAL (op);
  return (GET_CODE (op) == CONST_INT) && (
#line 172 "../../../../../../../work-shared/gcc-7.3.0-r0/gcc-7.3.0/gcc/config/arm/constraints.md"
(TARGET_THUMB1
  		    && ival > 1020 && ival <= 1275));
}
static inline bool
satisfies_constraint_Pd (rtx op)
{
  ...
  if (CONST_INT_P (op))
    ival = INTVAL (op);
  return (GET_CODE (op) == CONST_INT) && (
#line 178 "../../../../../../../work-shared/gcc-7.3.0-r0/gcc-7.3.0/gcc/config/arm/constraints.md"
...
satisfies_constraint_Pe (rtx op)
{
  ...
  if (CONST_INT_P (op))
    ival = INTVAL (op);
  return (GET_CODE (op) == CONST_INT) && (
#line 183 "../../../../../../../work-shared/gcc-7.3.0-r0/gcc-7.3.0/gcc/config/arm/constraints.md"
...
satisfies_constraint_Pf (rtx op)
{
  ...
  if (CONST_INT_P (op))
    ival = INTVAL (op);
  return (GET_CODE (op) == CONST_INT) && (
#line 188 "../../../../../../../work-shared/gcc-7.3.0-r0/gcc-7.3.0/gcc/config/arm/constraints.md"
...
satisfies_constraint_Ps (rtx op)
{
  ...
  if (CONST_INT_P (op))
    ival = INTVAL (op);
  return (GET_CODE (op) == CONST_INT) && (
#line 195 "../../../../../../../work-shared/gcc-7.3.0-r0/gcc-7.3.0/gcc/config/arm/constraints.md"
...
satisfies_constraint_Pt (rtx op)
{
  ...
  if (CONST_INT_P (op))
    ival = INTVAL (op);
  return (GET_CODE (op) == CONST_INT) && (
#line 200 "../../../../../../../work-shared/gcc-7.3.0-r0/gcc-7.3.0/gcc/config/arm/constraints.md"
...
satisfies_constraint_Pu (rtx op)
{
  ...
  if (CONST_INT_P (op))
    ival = INTVAL (op);
  return (GET_CODE (op) == CONST_INT) && (
#line 205 "../../../../../../../work-shared/gcc-7.3.0-r0/gcc-7.3.0/gcc/config/arm/constraints.md"
...
satisfies_constraint_Pv (rtx op)
{
  ...
  if (CONST_INT_P (op))
    ival = INTVAL (op);
  return (GET_CODE (op) == CONST_INT) && (
#line 210 "../../../../../../../work-shared/gcc-7.3.0-r0/gcc-7.3.0/gcc/config/arm/constraints.md"
...
satisfies_constraint_Pw (rtx op)
{
  ...
  if (CONST_INT_P (op))
    ival = INTVAL (op);
  return (GET_CODE (op) == CONST_INT) && (
#line 215 "../../../../../../../work-shared/gcc-7.3.0-r0/gcc-7.3.0/gcc/config/arm/constraints.md"
...
satisfies_constraint_Px (rtx op)
{
  ...
  if (CONST_INT_P (op))
    ival = INTVAL (op);
  return (GET_CODE (op) == CONST_INT) && (
#line 220 "../../../../../../../work-shared/gcc-7.3.0-r0/gcc-7.3.0/gcc/config/arm/constraints.md"
...
satisfies_constraint_Py (rtx op)
{
  ...
  if (CONST_INT_P (op))
    ival = INTVAL (op);
  return (GET_CODE (op) == CONST_INT) && (
#line 225 "../../../../../../../work-shared/gcc-7.3.0-r0/gcc-7.3.0/gcc/config/arm/constraints.md"
...
satisfies_constraint_Pz (rtx op)
{
  ...
  if (CONST_INT_P (op))
    ival = INTVAL (op);
  return (GET_CODE (op) == CONST_INT) && (
#line 230 "../../../../../../../work-shared/gcc-7.3.0-r0/gcc-7.3.0/gcc/config/arm/constraints.md"
...
#line 235 "../../../../../../../work-shared/gcc-7.3.0-r0/gcc-7.3.0/gcc/config/arm/constraints.md"
...
#line 241 "../../../../../../../work-shared/gcc-7.3.0-r0/gcc-7.3.0/gcc/config/arm/constraints.md"
...
satisfies_constraint_Da (rtx op)
{
  ...
  return 
#line 248 "../../../../../../../work-shared/gcc-7.3.0-r0/gcc-7.3.0/gcc/config/arm/constraints.md"
...
satisfies_constraint_Db (rtx op)
{
  ...
  return 
#line 255 "../../../../../../../work-shared/gcc-7.3.0-r0/gcc-7.3.0/gcc/config/arm/constraints.md"
...
satisfies_constraint_Dc (rtx op)
{
  ...
  return 
#line 263 "../../../../../../../work-shared/gcc-7.3.0-r0/gcc-7.3.0/gcc/config/arm/constraints.md"
...
satisfies_constraint_Dd (rtx op)
{
  ...
  if (CONST_INT_P (op))
    ival = INTVAL (op);
  return (GET_CODE (op) == CONST_INT) && (
#line 270 "../../../../../../../work-shared/gcc-7.3.0-r0/gcc-7.3.0/gcc/config/arm/constraints.md"
...
satisfies_constraint_De (rtx op)
{
  ...
  if (CONST_INT_P (op))
    ival = INTVAL (op);
  return (GET_CODE (op) == CONST_INT) && (
#line 276 "../../../../../../../work-shared/gcc-7.3.0-r0/gcc-7.3.0/gcc/config/arm/constraints.md"
...
satisfies_constraint_Df (rtx op)
{
  ...
  if (CONST_INT_P (op))
    ival = INTVAL (op);
  return (GET_CODE (op) == CONST_INT) && (
#line 282 "../../../../../../../work-shared/gcc-7.3.0-r0/gcc-7.3.0/gcc/config/arm/constraints.md"
...
satisfies_constraint_Dg (rtx op)
{
  ...
  if (CONST_INT_P (op))
    ival = INTVAL (op);
  return (GET_CODE (op) == CONST_INT) && (
#line 288 "../../../../../../../work-shared/gcc-7.3.0-r0/gcc-7.3.0/gcc/config/arm/constraints.md"
...
satisfies_constraint_Di (rtx op)
{
  ...
  return 
#line 295 "../../../../../../../work-shared/gcc-7.3.0-r0/gcc-7.3.0/gcc/config/arm/constraints.md"
...
satisfies_constraint_Dn (rtx op)
{
  ...
  return 
#line 302 "../../../../../../../work-shared/gcc-7.3.0-r0/gcc-7.3.0/gcc/config/arm/constraints.md"
(TARGET_32BIT
...
{
  return (GET_CODE (op) == CONST_VECTOR) && (
#line 310 "../../../../../../../work-shared/gcc-7.3.0-r0/gcc-7.3.0/gcc/config/arm/constraints.md"
(TARGET_32BIT
...
{
  return (GET_CODE (op) == CONST_VECTOR) && (
#line 318 "../../../../../../../work-shared/gcc-7.3.0-r0/gcc-7.3.0/gcc/config/arm/constraints.md"
(TARGET_32BIT
...
satisfies_constraint_Do (rtx op)
{
  ...
  if (CONST_INT_P (op))
    ival = INTVAL (op);
  return (GET_CODE (op) == CONST_INT) && (
#line 325 "../../../../../../../work-shared/gcc-7.3.0-r0/gcc-7.3.0/gcc/config/arm/constraints.md"
...
{
  return (GET_CODE (op) == CONST_DOUBLE) && (
#line 332 "../../../../../../../work-shared/gcc-7.3.0-r0/gcc-7.3.0/gcc/config/arm/constraints.md"
...
{
  return (GET_CODE (op) == CONST_DOUBLE) && (
#line 339 "../../../../../../../work-shared/gcc-7.3.0-r0/gcc-7.3.0/gcc/config/arm/constraints.md"
...
{
  return (GET_CODE (op) == CONST_DOUBLE) && (
#line 345 "../../../../../../../work-shared/gcc-7.3.0-r0/gcc-7.3.0/gcc/config/arm/constraints.md"
...
{
  return (GET_CODE (op) == CONST_DOUBLE) && (
#line 351 "../../../../../../../work-shared/gcc-7.3.0-r0/gcc-7.3.0/gcc/config/arm/constraints.md"
(TARGET_32BIT
...
{
  return (GET_CODE (op) == MEM) && (
#line 366 "../../../../../../../work-shared/gcc-7.3.0-r0/gcc-7.3.0/gcc/config/arm/constraints.md"
...
{
  return (GET_CODE (op) == MEM) && (
#line 373 "../../../../../../../work-shared/gcc-7.3.0-r0/gcc-7.3.0/gcc/config/arm/constraints.md"
...
{
  return (GET_CODE (op) == MEM) && (
#line 379 "../../../../../../../work-shared/gcc-7.3.0-r0/gcc-7.3.0/gcc/config/arm/constraints.md"
...
{
  return (GET_CODE (op) == MEM) && (
#line 385 "../../../../../../../work-shared/gcc-7.3.0-r0/gcc-7.3.0/gcc/config/arm/constraints.md"
...
{
  return (GET_CODE (op) == MEM) && (
#line 392 "../../../../../../../work-shared/gcc-7.3.0-r0/gcc-7.3.0/gcc/config/arm/constraints.md"
...
{
  return (GET_CODE (op) == MEM) && (
#line 399 "../../../../../../../work-shared/gcc-7.3.0-r0/gcc-7.3.0/gcc/config/arm/constraints.md"
...
{
  return (GET_CODE (op) == MEM) && (
#line 406 "../../../../../../../work-shared/gcc-7.3.0-r0/gcc-7.3.0/gcc/config/arm/constraints.md"
...
{
  return (GET_CODE (op) == MEM) && (
#line 412 "../../../../../../../work-shared/gcc-7.3.0-r0/gcc-7.3.0/gcc/config/arm/constraints.md"
(TARGET_ARM
...
{
  return (GET_CODE (op) == MEM) && (
#line 421 "../../../../../../../work-shared/gcc-7.3.0-r0/gcc-7.3.0/gcc/config/arm/constraints.md"
(REG_P (XEXP (op, 0))));
}
static inline bool
...
{
  return (GET_CODE (op) == MEM) && (
#line 427 "../../../../../../../work-shared/gcc-7.3.0-r0/gcc-7.3.0/gcc/config/arm/constraints.md"
(TARGET_THUMB
...
{
  return (GET_CODE (op) == MEM) && (
#line 439 "../../../../../../../work-shared/gcc-7.3.0-r0/gcc-7.3.0/gcc/config/arm/constraints.md"
(TARGET_THUMB
		   && thumb1_legitimate_address_p (GET_MODE (op), XEXP (op, 0),
						   0)
		   && GET_CODE (XEXP (op, 0)) != POST_INC));
...
{
  return (GET_CODE (op) == MEM) && (
#line 454 "../../../../../../../work-shared/gcc-7.3.0-r0/gcc-7.3.0/gcc/config/arm/constraints.md"
